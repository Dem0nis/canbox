static void SUBARU_SJ_ms_wheel_handler(const uint8_t * msg, struct msg_desc_t * desc)
{
	if (is_timeout(desc)) {
		carstate.wheel = 0;
		return;
...
static void SUBARU_SJ_ms_speed_handler(const uint8_t * msg, struct msg_desc_t * desc)
{
	if (is_timeout(desc)) {
		carstate.speed = 0;
		return;
...
static void SUBARU_SJ_ms_ign_brake_doors_handler(const uint8_t * msg, struct msg_desc_t * desc)
{
	if (is_timeout(desc)) {
...
static void SUBARU_SJ_ms_light_handler(const uint8_t * msg, struct msg_desc_t * desc)
{
	if (is_timeout(desc)) {
...
static void SUBARU_SJ_ms_drive_mode_handler(const uint8_t * msg, struct msg_desc_t * desc)
{
	if (is_timeout(desc)) {
...
static void SUBARU_SJ_ms_odometer(const uint8_t * msg, struct msg_desc_t * desc)
{
	if (is_timeout(desc)) {
		carstate.odometer = 0;
		return;
...
static void SUBARU_SJ_ms_tacho_handler(const uint8_t * msg, struct msg_desc_t * desc)
{
	if (is_timeout(desc)) {
		carstate.taho = 0;
		return;
...
static void SUBARU_SJ_ms_temp_handler(const uint8_t * msg, struct msg_desc_t * desc)
{
	if (is_timeout(desc)) {
		carstate.temp = 0;
		return;
...
{
	{ 0x025,  	 80, 0, 0, SUBARU_SJ_ms_wheel_handler },
	{ 0x0b4,	100, 0, 0, SUBARU_SJ_ms_speed_handler },
	{ 0x620,    200, 0, 0, SUBARU_SJ_ms_ign_brake_doors_handler },
	{ 0x622,   1000, 0, 0, SUBARU_SJ_ms_light_handler },
	{ 0x3b4,   1000, 0, 0, SUBARU_SJ_ms_drive_mode_handler},
	{ 0x611,   1000, 0, 0, SUBARU_SJ_ms_odometer},
	{ 0x2c4,    100, 0, 0, SUBARU_SJ_ms_tacho_handler},
	{ 0x3b0,   2000, 0, 0, SUBARU_SJ_ms_temp_handler},
};
